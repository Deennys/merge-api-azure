...
public class EnderecoDao {
	...
	/**
	 * Metodo para atualizar pelo id do candidato
	 * 
	 * @param endereco
	 * @param id
	 * @throws SQLException
	...
	/**
	 * Metodo para selecionar pelo id do candidato
	 * 
	 * @param id
	 * @return
	 * @throws SQLException
	...
	public Endereco select(int id) throws SQLException, IdNotFoundException {
		...
		PreparedStatement stmt = conexao
				.prepareStatement("select * from T_MERGE_ENDERECO_CANDIDATO where ID_CANDIDATO = ?");
	...
	/**
	 * Metodo para listar varios enderecos
	 * 
